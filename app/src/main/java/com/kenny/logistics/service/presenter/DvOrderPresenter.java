...
import com.kenny.logistics.service.retrofit.RetrofitDvOrder;
...
public class DvOrderPresenter implements BasePresenter {
    ...
    public DvOrderPresenter(Context context) {
    ...
    public void onInfo(String token,Integer current,Integer pageSize, final int event) {
        RetrofitDvOrder service = RetrofitHelper.getInstance(mContext).getRetrofitDvOrder();
