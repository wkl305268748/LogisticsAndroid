...
public class SpMainFragment extends BaseFragment {
    ...
    public static SpMainFragment instance;


    public static SpMainFragment newInstance() {
        Bundle args = new Bundle();
        SpMainFragment fragment = new SpMainFragment();
    ...
    private void initFragment() {
        SupportFragment HOMEFragment = findFragment(SpHomeFragment.class);
        if (HOMEFragment == null) {
            mFragments[HOME] = SpHomeFragment.newInstance();
            mFragments[ORDER] = SpOrderFragment.newInstance();
            mFragments[MESSAGE] = SpMessageFragment.newInstance();
            mFragments[USER] = SpUserFragment.newInstance();
            ...
            mFragments[ORDER] = findFragment(SpOrderFragment.class);
            mFragments[MESSAGE] = findFragment(SpMessageFragment.class);
            mFragments[USER] = findFragment(SpUserFragment.class);
        }
    }
    ...
    public void onMakeClicked(View view) {
        start(SpCreateOrderFragment.newInstance());
    }
