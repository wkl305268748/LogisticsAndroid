...
public class ItemOrderSignAdapter extends RecyclerView.Adapter<ItemOrderSignAdapter.MyViewHolder> {
    private List<OrderSet> mItems = new ArrayList<>();
    private LayoutInflater mInflater;
    private OnItemClickListener mClickListener;
    Context context;

    public ItemOrderSignAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_sign_order, parent, false);
